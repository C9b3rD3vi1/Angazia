...
type Subscription struct {
	...
	Interval       string     `json:"interval" gorm:"size:20;default:'month'"` // month, year
	Status         string     `json:"status" gorm:"size:50;default:'active';index"` // active, cancelled, expired, past_due
	...
	Features       JSONArray  `json:"features" gorm:"type:jsonb"`
	...
	LastPaymentID  *string    `json:"last_payment_id,omitempty" gorm:"type:uuid"`
...
type SubscriptionHistory struct {
	...
	Action         string     `json:"action" gorm:"size:50;not null"` // created, upgraded, downgraded, cancelled, renewed, expired
...
type SubscriptionUsage struct {
	...
	SubscriptionID string    `json:"subscription_id" gorm:"type:uuid;not null;index"`
	UserID         string    `json:"user_id" gorm:"type:uuid;not null;index"`
	MetricKey      string    `json:"metric_key" gorm:"size:100;not null;index"` // job_posts, api_calls, team_members
